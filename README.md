...
10. Переименовываем эти файлы, убираем мусор из названия (`Story05_CG01.m2v` и `Story05_CG01.hca`). Для этого можно выделить оба файла через Ctrl и нажать F2, тогда переименуются выбранные файлы.
