...
ffmpeg - конвертировать медиа после VGMToolBox, использую [билд отсюда](https://www.gyan.dev/ffmpeg/builds/). Размещена, где угодно. В скрипте указывается путь до неё.

VGMToolBox - экспортировать медиа и аудио из usmиспользую [билд отсюда](https://sourceforge.net/projects/vgmtoolbox/). Размещена, где угодно. В скриптах не используется.
