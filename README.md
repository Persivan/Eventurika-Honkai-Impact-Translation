...
До версии 5.8 (в 5.8 произошел переход на .usm формат) использовались mp4 файлы. Их битрейт намного выше (качество выше), поэтому рекомендую использовать их для сборки синематиков до версии игры 5.8.
